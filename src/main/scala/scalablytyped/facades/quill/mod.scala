package facades.quill

import facades.parchment.blotMod.Blot
import facades.quill.anon.Html
import facades.quill.quillBooleans.`false`
import facades.quill.quillBooleans.`true`
import facades.quill.quillStrings.`editor-change`
import facades.quill.quillStrings.`selection-change`
import facades.quill.quillStrings.`text-change`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - facades.quill.quillStrings.api
    - facades.quill.quillStrings.user
    - facades.quill.quillStrings.silent
  */
  trait Sources extends StObject
  object Sources {
    
    @scala.inline
    def api: facades.quill.quillStrings.api = "api".asInstanceOf[facades.quill.quillStrings.api]
    
    @scala.inline
    def silent: facades.quill.quillStrings.silent = "silent".asInstanceOf[facades.quill.quillStrings.silent]
    
    @scala.inline
    def user: facades.quill.quillStrings.user = "user".asInstanceOf[facades.quill.quillStrings.user]
  }
