...
import anduin.facades.monacoEditor.mod.editor.BuiltinTheme
import anduin.facades.monacoEditor.mod.editor.EditorAutoClosingOvertypeStrategy
import anduin.facades.monacoEditor.mod.editor.EditorAutoClosingStrategy
import anduin.facades.monacoEditor.mod.editor.EditorAutoSurroundStrategy
import anduin.facades.monacoEditor.mod.editor.GoToLocationValues
import anduin.facades.monacoEditor.mod.editor._LineNumbersType
import anduin.facades.monacoEditor.mod.languages.json.SeverityLevel
...
object monacoEditorStrings {
  ...
  @js.native
  sealed trait ignore extends SeverityLevel
  @scala.inline
