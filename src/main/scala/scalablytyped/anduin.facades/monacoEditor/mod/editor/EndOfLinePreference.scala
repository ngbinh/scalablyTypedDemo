...
object EndOfLinePreference extends StObject {
  ...
  /* 2 */ val CRLF: anduin.facades.monacoEditor.mod.editor.EndOfLinePreference.CRLF with Double = js.native
  ...
  /* 1 */ val LF: anduin.facades.monacoEditor.mod.editor.EndOfLinePreference.LF with Double = js.native
  ...
  /* 0 */ val TextDefined: anduin.facades.monacoEditor.mod.editor.EndOfLinePreference.TextDefined with Double = js.native
}
