...
import anduin.facades.monacoEditor.monacoEditorStrings.hidden
import anduin.facades.monacoEditor.monacoEditorStrings.visible
...
trait IEditorScrollbarOptions extends StObject {
  ...
  /**
    ...
    * Defaults to false.
    */
  var scrollByPage: js.UndefOr[Boolean] = js.native
...
object IEditorScrollbarOptions {
  ...
  implicit class IEditorScrollbarOptionsMutableBuilder[Self <: IEditorScrollbarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScrollByPage(value: Boolean): Self = StObject.set(x, "scrollByPage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScrollByPageUndefined: Self = StObject.set(x, "scrollByPage", js.undefined)
