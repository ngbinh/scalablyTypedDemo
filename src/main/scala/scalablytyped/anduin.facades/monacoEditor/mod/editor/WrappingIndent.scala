...
object WrappingIndent extends StObject {
  ...
  /* 3 */ val DeepIndent: anduin.facades.monacoEditor.mod.editor.WrappingIndent.DeepIndent with Double = js.native
  ...
  /* 2 */ val Indent: anduin.facades.monacoEditor.mod.editor.WrappingIndent.Indent with Double = js.native
  ...
  /* 0 */ val None: anduin.facades.monacoEditor.mod.editor.WrappingIndent.None with Double = js.native
  ...
  /* 1 */ val Same: anduin.facades.monacoEditor.mod.editor.WrappingIndent.Same with Double = js.native
}
