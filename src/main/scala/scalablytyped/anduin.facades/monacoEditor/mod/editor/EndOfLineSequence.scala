...
object EndOfLineSequence extends StObject {
  ...
  /* 1 */ val CRLF: anduin.facades.monacoEditor.mod.editor.EndOfLineSequence.CRLF with Double = js.native
  ...
  /* 0 */ val LF: anduin.facades.monacoEditor.mod.editor.EndOfLineSequence.LF with Double = js.native
}
