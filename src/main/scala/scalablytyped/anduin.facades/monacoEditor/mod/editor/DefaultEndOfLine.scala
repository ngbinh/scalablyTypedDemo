...
object DefaultEndOfLine extends StObject {
  ...
  /* 2 */ val CRLF: anduin.facades.monacoEditor.mod.editor.DefaultEndOfLine.CRLF with Double = js.native
  ...
  /* 1 */ val LF: anduin.facades.monacoEditor.mod.editor.DefaultEndOfLine.LF with Double = js.native
}
