...
object MinimapPosition extends StObject {
  ...
  /* 2 */ val Gutter: anduin.facades.monacoEditor.mod.editor.MinimapPosition.Gutter with Double = js.native
  
  @js.native
  sealed trait Inline extends MinimapPosition
  /* 1 */ val Inline: anduin.facades.monacoEditor.mod.editor.MinimapPosition.Inline with Double = js.native
}
