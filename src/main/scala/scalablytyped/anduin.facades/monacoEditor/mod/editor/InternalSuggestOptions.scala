...
import anduin.facades.monacoEditor.monacoEditorStrings.insert
import anduin.facades.monacoEditor.monacoEditorStrings.replace
...
trait InternalSuggestOptions extends StObject {
  ...
  val showInlineDetails: Boolean = js.native
  ...
  val showStatusBar: Boolean = js.native
...
object InternalSuggestOptions {
  ...
  implicit class InternalSuggestOptionsMutableBuilder[Self <: InternalSuggestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShowInlineDetails(value: Boolean): Self = StObject.set(x, "showInlineDetails", value.asInstanceOf[js.Any])
