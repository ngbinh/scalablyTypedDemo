...
object IViewZone {
  ...
  implicit class IViewZoneMutableBuilder[Self <: IViewZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnComputedHeight(value: /* height */ Double => Callback): Self = StObject.set(x, "onComputedHeight", js.Any.fromFunction1((t0: /* height */ Double) => value(t0).runNow()))
    
    @scala.inline
    def setOnComputedHeightUndefined: Self = StObject.set(x, "onComputedHeight", js.undefined)
    
    @scala.inline
    def setOnDomNodeTop(value: /* top */ Double => Callback): Self = StObject.set(x, "onDomNodeTop", js.Any.fromFunction1((t0: /* top */ Double) => value(t0).runNow()))
