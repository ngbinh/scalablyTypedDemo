...
import anduin.facades.monacoEditor.monacoEditorStrings.`block-outline`
import anduin.facades.monacoEditor.monacoEditorStrings.`inline`
import anduin.facades.monacoEditor.monacoEditorStrings.`line-thin`
import anduin.facades.monacoEditor.monacoEditorStrings.`underline-thin`
...
import anduin.facades.monacoEditor.monacoEditorStrings.alt
import anduin.facades.monacoEditor.monacoEditorStrings.always
import anduin.facades.monacoEditor.monacoEditorStrings.auto
import anduin.facades.monacoEditor.monacoEditorStrings.blink
import anduin.facades.monacoEditor.monacoEditorStrings.block
...
import anduin.facades.monacoEditor.monacoEditorStrings.brackets
import anduin.facades.monacoEditor.monacoEditorStrings.copy
import anduin.facades.monacoEditor.monacoEditorStrings.ctrlCmd
import anduin.facades.monacoEditor.monacoEditorStrings.deepIndent
...
import anduin.facades.monacoEditor.monacoEditorStrings.expand
...
import anduin.facades.monacoEditor.monacoEditorStrings.indent
...
import anduin.facades.monacoEditor.monacoEditorStrings.keep
...
import anduin.facades.monacoEditor.monacoEditorStrings.phase
...
import anduin.facades.monacoEditor.monacoEditorStrings.same
...
import anduin.facades.monacoEditor.monacoEditorStrings.smooth
import anduin.facades.monacoEditor.monacoEditorStrings.solid
...
import anduin.facades.monacoEditor.monacoEditorStrings.underline
...
trait IEditorOptions extends StObject {
  ...
  /**
    ...
    */
  var codeLensFontFamily: js.UndefOr[String] = js.native
  
  /**
    * Code lens font size. Default to 90% of the editor font size
    */
  var codeLensFontSize: js.UndefOr[Double] = js.native
  ...
  /**
    ...
    */
  var inlineHints: js.UndefOr[IEditorInlineHintsOptions] = js.native
  ...
  /**
    ...
    * Defaults to false.
    */
  var linkedEditing: js.UndefOr[Boolean] = js.native
  ...
  /**
    ...
    * Defaults to false.
    */
  var peekWidgetDefaultFocus: js.UndefOr[tree | anduin.facades.monacoEditor.monacoEditorStrings.editor] = js.native
  ...
  /**
    ...
    */
  var smartSelect: js.UndefOr[ISmartSelectOptions] = js.native
  ...
  /**
    ...
    */
  var stickyTabStops: js.UndefOr[Boolean] = js.native
  ...
  /**
    ...
    * Defaults to 'prompt'.
    */
  var unusualLineTerminators: js.UndefOr[auto | off | prompt] = js.native
  ...
  /**
    ...
    */
  var wordWrapOverride1: js.UndefOr[off | on | inherit] = js.native
  
  /**
    * Override the `wordWrapOverride1` setting.
    */
  var wordWrapOverride2: js.UndefOr[off | on | inherit] = js.native
...
object IEditorOptions {
  ...
  implicit class IEditorOptionsMutableBuilder[Self <: IEditorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCodeLensFontFamily(value: String): Self = StObject.set(x, "codeLensFontFamily", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCodeLensFontFamilyUndefined: Self = StObject.set(x, "codeLensFontFamily", js.undefined)
    
    @scala.inline
    def setCodeLensFontSize(value: Double): Self = StObject.set(x, "codeLensFontSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCodeLensFontSizeUndefined: Self = StObject.set(x, "codeLensFontSize", js.undefined)
    ...
    @scala.inline
    def setInlineHints(value: IEditorInlineHintsOptions): Self = StObject.set(x, "inlineHints", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInlineHintsUndefined: Self = StObject.set(x, "inlineHints", js.undefined)
    ...
    @scala.inline
    def setLinkedEditing(value: Boolean): Self = StObject.set(x, "linkedEditing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkedEditingUndefined: Self = StObject.set(x, "linkedEditing", js.undefined)
    ...
    @scala.inline
    def setPeekWidgetDefaultFocus(value: tree | anduin.facades.monacoEditor.monacoEditorStrings.editor): Self = StObject.set(x, "peekWidgetDefaultFocus", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmartSelect(value: ISmartSelectOptions): Self = StObject.set(x, "smartSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSmartSelectUndefined: Self = StObject.set(x, "smartSelect", js.undefined)
    ...
    @scala.inline
    def setStickyTabStops(value: Boolean): Self = StObject.set(x, "stickyTabStops", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStickyTabStopsUndefined: Self = StObject.set(x, "stickyTabStops", js.undefined)
    ...
    @scala.inline
    def setUnusualLineTerminators(value: auto | off | prompt): Self = StObject.set(x, "unusualLineTerminators", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWordWrapOverride1(value: off | on | inherit): Self = StObject.set(x, "wordWrapOverride1", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordWrapOverride1Undefined: Self = StObject.set(x, "wordWrapOverride1", js.undefined)
    
    @scala.inline
    def setWordWrapOverride2(value: off | on | inherit): Self = StObject.set(x, "wordWrapOverride2", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordWrapOverride2Undefined: Self = StObject.set(x, "wordWrapOverride2", js.undefined)
