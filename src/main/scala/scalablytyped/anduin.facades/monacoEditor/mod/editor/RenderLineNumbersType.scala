...
object RenderLineNumbersType extends StObject {
  ...
  /* 4 */ val Custom: anduin.facades.monacoEditor.mod.editor.RenderLineNumbersType.Custom with Double = js.native
  
  @js.native
  sealed trait Interval extends RenderLineNumbersType
  /* 3 */ val Interval: anduin.facades.monacoEditor.mod.editor.RenderLineNumbersType.Interval with Double = js.native
  
  @js.native
  sealed trait Off extends RenderLineNumbersType
  /* 0 */ val Off: anduin.facades.monacoEditor.mod.editor.RenderLineNumbersType.Off with Double = js.native
  
  @js.native
  sealed trait On extends RenderLineNumbersType
  /* 1 */ val On: anduin.facades.monacoEditor.mod.editor.RenderLineNumbersType.On with Double = js.native
  
  @js.native
  sealed trait Relative extends RenderLineNumbersType
  /* 2 */ val Relative: anduin.facades.monacoEditor.mod.editor.RenderLineNumbersType.Relative with Double = js.native
}
