...
object ScrollType extends StObject {
  ...
  /* 1 */ val Immediate: anduin.facades.monacoEditor.mod.editor.ScrollType.Immediate with Double = js.native
  
  @js.native
  sealed trait Smooth extends ScrollType
  /* 0 */ val Smooth: anduin.facades.monacoEditor.mod.editor.ScrollType.Smooth with Double = js.native
}
