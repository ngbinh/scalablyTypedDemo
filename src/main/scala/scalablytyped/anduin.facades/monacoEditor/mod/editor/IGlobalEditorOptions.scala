...
import anduin.facades.monacoEditor.monacoEditorBooleans.`false`
import anduin.facades.monacoEditor.monacoEditorBooleans.`true`
import anduin.facades.monacoEditor.monacoEditorStrings.configuredByTheme
...
trait IGlobalEditorOptions extends StObject {
  ...
  /**
    ...
    */
  var wordBasedSuggestionsOnlySameLanguage: js.UndefOr[Boolean] = js.native
}
object IGlobalEditorOptions {
  ...
  implicit class IGlobalEditorOptionsMutableBuilder[Self <: IGlobalEditorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordBasedSuggestionsOnlySameLanguage(value: Boolean): Self = StObject.set(x, "wordBasedSuggestionsOnlySameLanguage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordBasedSuggestionsOnlySameLanguageUndefined: Self = StObject.set(x, "wordBasedSuggestionsOnlySameLanguage", js.undefined)
