...
object SelectionDirection extends StObject {
  ...
  /* 0 */ val LTR: anduin.facades.monacoEditor.mod.SelectionDirection.LTR with Double = js.native
  ...
  /* 1 */ val RTL: anduin.facades.monacoEditor.mod.SelectionDirection.RTL with Double = js.native
}
