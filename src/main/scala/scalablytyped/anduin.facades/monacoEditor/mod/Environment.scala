...
object Environment {
  ...
  implicit class EnvironmentMutableBuilder[Self <: Environment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGlobalAPI(value: Boolean): Self = StObject.set(x, "globalAPI", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGlobalAPIUndefined: Self = StObject.set(x, "globalAPI", js.undefined)
  }
}
