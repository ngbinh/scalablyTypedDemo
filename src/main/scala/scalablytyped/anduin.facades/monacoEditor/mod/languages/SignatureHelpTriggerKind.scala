...
object SignatureHelpTriggerKind extends StObject {
  ...
  /* 3 */ val ContentChange: anduin.facades.monacoEditor.mod.languages.SignatureHelpTriggerKind.ContentChange with Double = js.native
  
  @js.native
  sealed trait Invoke extends SignatureHelpTriggerKind
  /* 1 */ val Invoke: anduin.facades.monacoEditor.mod.languages.SignatureHelpTriggerKind.Invoke with Double = js.native
  
  @js.native
  sealed trait TriggerCharacter extends SignatureHelpTriggerKind
  /* 2 */ val TriggerCharacter: anduin.facades.monacoEditor.mod.languages.SignatureHelpTriggerKind.TriggerCharacter with Double = js.native
}
