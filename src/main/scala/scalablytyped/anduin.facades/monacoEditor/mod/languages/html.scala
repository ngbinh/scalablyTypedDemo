...
import anduin.facades.monacoEditor.monacoEditorStrings.`force-aligned`
import anduin.facades.monacoEditor.monacoEditorStrings.`force-expand-multiline`
import anduin.facades.monacoEditor.monacoEditorStrings.auto
import anduin.facades.monacoEditor.monacoEditorStrings.force
