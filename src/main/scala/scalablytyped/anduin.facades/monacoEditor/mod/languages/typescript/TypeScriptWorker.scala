...
trait TypeScriptWorker extends StObject {
  ...
  /**
    ...
    */
  def getSignatureHelpItems(fileName: String, position: Double, options: js.Any): js.Promise[js.UndefOr[_]] = js.native
...
object TypeScriptWorker {
  ...
  def apply(
    ...
    getSignatureHelpItems: (String, Double, js.Any) => js.Promise[js.UndefOr[_]],
  ...
  implicit class TypeScriptWorkerMutableBuilder[Self <: TypeScriptWorker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetSignatureHelpItems(value: (String, Double, js.Any) => js.Promise[js.UndefOr[_]]): Self = StObject.set(x, "getSignatureHelpItems", js.Any.fromFunction3(value))
