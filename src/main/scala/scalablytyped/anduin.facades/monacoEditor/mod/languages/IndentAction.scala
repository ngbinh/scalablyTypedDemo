...
object IndentAction extends StObject {
  ...
  /* 1 */ val Indent: anduin.facades.monacoEditor.mod.languages.IndentAction.Indent with Double = js.native
  ...
  /* 2 */ val IndentOutdent: anduin.facades.monacoEditor.mod.languages.IndentAction.IndentOutdent with Double = js.native
  ...
  /* 0 */ val None: anduin.facades.monacoEditor.mod.languages.IndentAction.None with Double = js.native
  ...
  /* 3 */ val Outdent: anduin.facades.monacoEditor.mod.languages.IndentAction.Outdent with Double = js.native
}
