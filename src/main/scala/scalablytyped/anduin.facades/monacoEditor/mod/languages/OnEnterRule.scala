...
trait OnEnterRule extends StObject {
  ...
  /**
    ...
    */
  var previousLineText: js.UndefOr[js.RegExp] = js.native
}
object OnEnterRule {
  ...
  implicit class OnEnterRuleMutableBuilder[Self <: OnEnterRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousLineText(value: js.RegExp): Self = StObject.set(x, "previousLineText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreviousLineTextUndefined: Self = StObject.set(x, "previousLineText", js.undefined)
  }
}
