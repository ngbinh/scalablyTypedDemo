...
trait IMonarchLanguage extends StObject {
  ...
  /**
    ...
    * Defaults to false
    */
  var includeLF: js.UndefOr[Boolean] = js.native
...
object IMonarchLanguage {
  ...
  implicit class IMonarchLanguageMutableBuilder[Self <: IMonarchLanguage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeLF(value: Boolean): Self = StObject.set(x, "includeLF", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIncludeLFUndefined: Self = StObject.set(x, "includeLF", js.undefined)
