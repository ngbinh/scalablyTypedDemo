...
object CompletionTriggerKind extends StObject {
  ...
  /* 0 */ val Invoke: anduin.facades.monacoEditor.mod.languages.CompletionTriggerKind.Invoke with Double = js.native
  
  @js.native
  sealed trait TriggerCharacter extends CompletionTriggerKind
  /* 1 */ val TriggerCharacter: anduin.facades.monacoEditor.mod.languages.CompletionTriggerKind.TriggerCharacter with Double = js.native
  
  @js.native
  sealed trait TriggerForIncompleteCompletions extends CompletionTriggerKind
  /* 2 */ val TriggerForIncompleteCompletions: anduin.facades.monacoEditor.mod.languages.CompletionTriggerKind.TriggerForIncompleteCompletions with Double = js.native
}
