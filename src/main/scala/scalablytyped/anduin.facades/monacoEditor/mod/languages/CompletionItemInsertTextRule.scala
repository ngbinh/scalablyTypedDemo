...
object CompletionItemInsertTextRule extends StObject {
  ...
  /* 4 */ val InsertAsSnippet: anduin.facades.monacoEditor.mod.languages.CompletionItemInsertTextRule.InsertAsSnippet with Double = js.native
  ...
  /* 1 */ val KeepWhitespace: anduin.facades.monacoEditor.mod.languages.CompletionItemInsertTextRule.KeepWhitespace with Double = js.native
}
