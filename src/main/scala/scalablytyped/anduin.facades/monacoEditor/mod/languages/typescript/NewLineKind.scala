...
object NewLineKind extends StObject {
  ...
  /* 0 */ val CarriageReturnLineFeed: anduin.facades.monacoEditor.mod.languages.typescript.NewLineKind.CarriageReturnLineFeed with Double = js.native
  
  @js.native
  sealed trait LineFeed extends NewLineKind
  /* 1 */ val LineFeed: anduin.facades.monacoEditor.mod.languages.typescript.NewLineKind.LineFeed with Double = js.native
}
