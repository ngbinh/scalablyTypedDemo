...
import anduin.facades.monacoEditor.anon.FileMatch
...
object json {
  ...
  trait DiagnosticsOptions extends StObject {
    ...
    /**
      ...
      */
    val schemaRequest: js.UndefOr[SeverityLevel] = js.native
    
    /**
      * The severity of problems from schema validation. If set to 'ignore', schema validation will be skipped. If not set, 'warning' is used.
      */
    val schemaValidation: js.UndefOr[SeverityLevel] = js.native
  ...
  object DiagnosticsOptions {
    ...
    implicit class DiagnosticsOptionsMutableBuilder[Self <: DiagnosticsOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSchemaRequest(value: SeverityLevel): Self = StObject.set(x, "schemaRequest", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSchemaRequestUndefined: Self = StObject.set(x, "schemaRequest", js.undefined)
      
      @scala.inline
      def setSchemaValidation(value: SeverityLevel): Self = StObject.set(x, "schemaValidation", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - `anduin.facades`.monacoEditor.monacoEditorStrings.error
    - `anduin.facades`.monacoEditor.monacoEditorStrings.warning
    - `anduin.facades`.monacoEditor.monacoEditorStrings.ignore
  */
  trait SeverityLevel extends StObject
  object SeverityLevel {
    
    @scala.inline
    def error: anduin.facades.monacoEditor.monacoEditorStrings.error = "error".asInstanceOf[anduin.facades.monacoEditor.monacoEditorStrings.error]
    
    @scala.inline
    def ignore: anduin.facades.monacoEditor.monacoEditorStrings.ignore = "ignore".asInstanceOf[anduin.facades.monacoEditor.monacoEditorStrings.ignore]
    
    @scala.inline
    def warning: anduin.facades.monacoEditor.monacoEditorStrings.warning = "warning".asInstanceOf[anduin.facades.monacoEditor.monacoEditorStrings.warning]
  }
}
